...
const LandingBody = () => {
    ...
    return (<div id="body-element" className='bg-white flex-grow grid grid-rows-8 sm:grid-rows-5 lg:grid-rows-4 grid-cols-1 sm:grid-cols-6 gap-4 m-8 ml-4 mr-4 sm:ml-16 sm:mr-16 lg:ml-32 lg:mr-32'>
                    {/* Element 1 */}
