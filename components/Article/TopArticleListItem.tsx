...
export const TopArticleListItem = ({ article }: { article: DocumentData }) => {
    ...
    return (
        <div className='w-1/5 flex-shrink-0 '>
            <Link href="/articles/[id]" as={`/articles/${currArticle.article_id}`} className="text-xl font-extra-bold text-blue-600 flex flex-col items-start justify-center space-y-2">
