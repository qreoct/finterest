...
export const ArticleFullDisplay = ({ articleId }: { articleId: string }) => {
    ...
    return (
        <ProtectedRoute>
            ...
            <div className="flex flex-row items-start h-screen overflow-y-hidden">
                {/* Navigation Bar */}
                ...
                <div id="article-element" className="w-full bg-white overflow-y-auto flex items-start h-screen">
                    ...
                    <button onClick={() => { router.push('/'); }} className="bg-transparent text-neutral-headings-black hover:text-gold-500 lg:ml-6 xl:ml-8 2xl:ml-12 mr-2 mt-12">
                    ...
                    <div className="flex flex-col justify-start mt-8 ml-8 mr-16 space-y-2">
                        ...
                        <img src={currArticle.image_url} alt={currArticle.title} className='w-2/3 h-2/3 xl:w-3/4 xl:h-3/4 2xl:w-1/2 2xl:h-1/2 self-center'/>
                        ...
                        <div id='article-content' className='article-content-div max-w-prose pb-10'>
                ...
                {/* Right Content */}
                <div id="chat-element" className="hidden flex-1 w-4/5 xl:flex xl:flex-auto xl:w-1/2 xl:max-w-lg bg-neutral-color-300 overflow-y-auto py-8">
                ...
                {/* AI Chat Button */}
                <div id='ai-chat-button' className="flex xl:hidden fixed bottom-10 right-10">
                    <button className="bg-gold-500 hover:bg-gold-900 text-white font-bold px-4 py-3 rounded-full flex justify-center items-center mt-5 self-center duration-200" onClick={ handleChatOpenOnClick }>
